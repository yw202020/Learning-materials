# -*- coding: utf-8 -*-
# @Time    : 2017-12-04 17:15
# @Author  : Storm
# @File    : mymd5.py

# codeing=utf-8
# 博客地址：http://blog.csdn.net/adidala/article/details/28677393
...
def fun(fun_list, f, m, shi):
    ...
    while count < 16:
        xx = int(fun_list[0], 16) + f(int(fun_list[1], 16), int(fun_list[2], 16), int(fun_list[3], 16)) + \
